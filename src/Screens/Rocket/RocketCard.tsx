    ...
    return (
        <div
            ...
            <div
                ...
                <button onClick={() => navigate(`/rockets/${rocket.id}`)} type='button' className="px-4 py-2 border border-white text-xl rounded-lg hover:bg-white hover:text-black">Learn More...</button>
            </div>
            <img src={rocket.flickr_images[0]} alt="" className="object-cover rounded-lg h-full w-full" />
        </div>
    )
}
